...
/* TIM1 registers */
#define R_TIM1_CR1      reg32(0x40010000)
#define R_TIM1_CR2      reg32(0x40010004)
#define R_TIM1_SMCR     reg32(0x40010008)
#define R_TIM1_DIER     reg32(0x4001000c)
#define R_TIM1_SR       reg32(0x40010010)
#define R_TIM1_EGR      reg32(0x40010014)
#define R_TIM1_CCMR1    reg32(0x40010018)
#define R_TIM1_CCMR2    reg32(0x4001001c)
#define R_TIM1_CCER     reg32(0x40010020)
#define R_TIM1_CNT      reg32(0x40010024)
#define R_TIM1_PSC      reg32(0x40010028)
#define R_TIM1_ARR      reg32(0x4001002c)
#define R_TIM1_RCR      reg32(0x40010030)
#define R_TIM1_CCR1     reg32(0x40010034)
#define R_TIM1_CCR2     reg32(0x40010038)
#define R_TIM1_CCR3     reg32(0x4001003c)
#define R_TIM1_CCR4     reg32(0x40010040)
#define R_TIM1_BDTR     reg32(0x40010044)
#define R_TIM1_DCR      reg32(0x40010048)
#define R_TIM1_DMAR     reg32(0x4001004c)

/* TIM5 registers */
#define R_TIM5_CR1      reg32(0x40000c00)
#define R_TIM5_CR2      reg32(0x40000c04)
#define R_TIM5_SMCR     reg32(0x40000c08)
#define R_TIM5_DIER     reg32(0x40000c0c)
#define R_TIM5_SR       reg32(0x40000c10)
#define R_TIM5_EGR      reg32(0x40000c14)
#define R_TIM5_CCMR1    reg32(0x40000c18)
#define R_TIM5_CCMR2    reg32(0x40000c1c)
#define R_TIM5_CCER     reg32(0x40000c20)
#define R_TIM5_CNT      reg32(0x40000c24)
#define R_TIM5_PSC      reg32(0x40000c28)
#define R_TIM5_ARR      reg32(0x40000c2c)
#define R_TIM5_CCR1     reg32(0x40000c34)
#define R_TIM5_CCR2     reg32(0x40000c38)
#define R_TIM5_CCR3     reg32(0x40000c3c)
#define R_TIM5_CCR4     reg32(0x40000c40)
#define R_TIM5_DCR      reg32(0x40000c48)
#define R_TIM5_DMAR     reg32(0x40000c4c)
#define R_TIM5_OR       reg32(0x40000c50)
